...
function readData(fileName){
    let dataRead = fs.readFileSync('./data/analysis.json');
...
function writeData(info){
    ...
    fs.writeFileSync('./data/analysis.json', data);
}
...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
		...
		var siblings = readData("siblings");
		var animal = readData("animal");
        var color = readData("color");
        var social = readData("social");
		console.log(name);
        res.render('showResults', {results: [name, country, siblings, animal, color, social]});
        console.log([name, country, siblings, animal, color, social]);
    });
